...
class ElementRenderer extends GUIRenderer{
	...
	public function __construct(GUIElement $element){
        ...
        if($element instanceof Font) $this->tag = "span";
        elseif($element instanceof Color) $this->tag = null;		
	...
	public function renderHorizontal(){
	    if($this->component->getHorizontal()) $this->setRender(" text-align:{$this->component->getHorizontal()};");
        return $this;		
	}
	...
	public function renderVertical(){
	    if($this->component->getVertical()) $this->setRender(" vertical-align:{$this->component->getVertical()};");
        return $this;		
	}
	...
	public function renderWidth(){
	    if($this->component->getWidth()){
            if($this->component instanceof Dimension) $this->setRender(" width:{$this->component->getWidth()};");
            else $this->setRender(" {$this->component->getWidth()};");
        }
        return $this;		
	}
	...
	public function renderHeight(){
	    if($this->component->getHeight()) $this->setRender(" height:{$this->component->getHeight()};");
        return $this;		
	}
	...
	public function renderImage(){
        ...
        if($image instanceof Image){
		    if($this->component instanceof Background) $this->setRender(" background-image:");
		    elseif($this->component instanceof Borders){
			    $this->setRender(" border-image:");		
				if($image->getWidth()) $this->setRender(" {$image->getWidth()} {$image->getHeight()}"); 
			}	
	...
	public function renderRadius(){
	    if($this->component->getRadius()) $this->setRender(" border-radius:{$this->component->getRadius()};");
        return $this;		
	}
	...
	public function renderSize(){
	    if($this->component->getSize()) $this->setRender(" font-size: {$this->component->getSize()}px;");
        return $this;		
	}
	...
	public function renderFamily(){
	    if($this->component->getFamily()) $this->setRender(" font-family: {$this->component->getFamily()};");
        return $this;		
	}
	...
	public function renderVariant(){
	    if($this->component->getVariant()) $this->setRender(" font-variant: {$this->component->getVariant()};");
        return $this;		
	}
	...
	public function renderWeight(){
	    if($this->component->getWeight()) $this->setRender(" font-weight: {$this->component->getWeight()};");
        return $this;		
	}
	...
	public function renderStyle(){
	    if($this->component->getStyle()) $this->setRender(" style: {$this->component->getStyle()};");
        return $this;		
	}
