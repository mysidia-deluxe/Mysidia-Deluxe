...
<nav class="navbar navbar-expand-lg" style="background-color: #1c2b49; font-size: 20px;">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
	  <a class="nav-item nav-link btn btn-night" href="#" style="background-color:#4e6da9; border-color:#08192b"><i class="fas fa-globe-americas"></i> Explore</a>&nbsp;
	  ...
	  <a class="nav-item nav-link btn btn-night" href="#"><i class="fas fa-store-alt"></i> Shops</a>&nbsp;
