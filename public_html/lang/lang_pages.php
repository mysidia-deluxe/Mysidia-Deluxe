...
//Language variables used for Pages.php

$lang['error'] = "404 Page Not Found";
$lang['nonexist'] = "The page you are looking for cannot be found on this site.  
                     It is possible that it never existed or that the site admin deleted it.";
$lang['code_title'] = "Enter Password";
$lang['code'] = "This page is protected by promocode, please enter the code to proceed.";
$lang['wrongcode'] = "It appears that you have entered the wrong password to unlock this page.";
$lang['nocode'] = "The promocode validation failed, it might not belong to you or it could have expired.";
$lang['item_title'] = "Select an Item";
$lang['item'] = "This page can only be unlocked with a special item, now choose the appropriate one from your inventory.";
$lang['wrongitem'] = "Unfortunately, you have selected the incorrect item to unlock this page.";
$lang['noitem'] = "You do not have the required item to access this page";
$lang['wrongtime'] = "Cannot access this page at this moment, please return later.";
$lang['notgroup'] = "Only authorized users are allowed to view this page.";
