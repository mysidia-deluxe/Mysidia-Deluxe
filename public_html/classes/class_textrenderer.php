...
class TextRenderer extends GUIRenderer
{
    ...
    {
        if (!$this->component->isAutocomplete()) {
            $this->setRender(" autocomplete='off'");
        }
        return $this;
    }
    ...
    {
        if ($this->component->getAccept()) {
            $this->setRender(" accept='{$this->component->getAccept()}/*'>");
        } else {
            $this->setRender(">");
        }
        return $this;
    ...
    {
        if ($this->component instanceof TextArea) {
            $this->setRender(">{$this->component->getValue()} ");
        } elseif (!is_null($this->component->getValue())) {
