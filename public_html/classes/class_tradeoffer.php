...
class TradeOffer extends Model
{
    ...
    public function __construct($tid, $new = false)
    {
        ...
        if ($new) {
            ...
            if (!is_object($row)) {
                throw new TradeNotfoundException("Trade Offer id:{$tid} does not exist...");
            }
    ...
    {
        if ($fetchMode == Model::MODEL) {
            return new Member($this->recipient);
        }
    ...
    {
        if ($assignMode == Model::UPDATE) {
            $this->save("adoptoffered", $adoptOffered);
        }
    ...
    {
        if ($assignMode == Model::UPDATE) {
            $this->save("adoptwanted", $adoptWanted);
        }
    ...
    {
        if ($assignMode == Model::UPDATE) {
            $this->save("itemoffered", $itemOffered);
        }
    ...
    {
        if ($assignMode == Model::UPDATE) {
            $this->save("itemwanted", $itemWanted);
        }
    ...
    {
        if ($assignMode == Model::UPDATE) {
            $this->save("cashoffered", $cashOffered);
        }
