...
class Font extends GUIElement
{
    ...
    */
    ...
    {
        if (!is_numeric($size)) {
            throw new GUIException("The specified font size is not numeric!");
        }
        $this->size = $size;
    ...
    public function setVariant($variant)
    {
        ...
        if (!in_array($variant, $variants)) {
            throw new GUIException("The specified font variant property is invalid.");
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (!in_array($weight, $weights) and !is_numeric($weight)) {
            throw new GUIException("The specified font weight property is invalid.");
        }
        $this->weight = $weight;
