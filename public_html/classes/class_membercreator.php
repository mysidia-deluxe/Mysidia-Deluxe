...
class MemberCreator extends UserCreator
{
    ...
    {
        if (empty($userinfo)) {
            throw new Exception('User id or Username does not exist...');
        }
    ...
    public function getgroupcategory()
    {
        ...
        if ($this->usergroup == 1 or $this->usergroup == 2) {
            return "Admin";
        } elseif ($this->usergroup == 4 or $this->usergroup == 6) {
            return "Mod";
            ...
            throw new Exception('Cannot recognize usergroup category for this user, he/she may be a guest, a bot, or else...');
        }
    }
