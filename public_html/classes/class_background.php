    ...
    */
    ...
    public function __construct($source = "", $position = "", $repeat = "", $origin = "")
    {
        ...
        if (!empty($source)) {
            if ($source instanceof Color) {
                ...
                throw new GUIException("The specified source is invalid.");
            }
        }
        if (!empty($position)) {
    ...
    public function setAttachment($attachment)
    {
        ...
        if (!in_array($attachment, $attachments)) {
            throw new GUIException("The specified attachment type is invalid.");
        }
    ...
    public function setPosition($position)
    {
        ...
        if (!in_array($position, $positions)) {
            throw new GUIException("The specified position property is invalid.");
        }
    ...
    public function setRepeat($repeat)
    {
        ...
        if (!in_array($repeat, $repeats)) {
            throw new GUIException("The specified clip property is invalid.");
        }
        $this->repeat = $repeat;
    ...
    public function setOrigin($origin)
    {
        ...
        if (!in_array($origin, $origins)) {
            throw new GUIException("The specified origin property is invalid.");
        }
        $this->origin = $origin;
