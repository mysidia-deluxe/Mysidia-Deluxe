...
final class Trade extends Object
{
    ...
    public function getValidator()
    {
        ...
        foreach ($validations as $validation) {
            $validationList->add(new Mystring($validation));
        }
    ...
    public function offer()
    {
        ...
        if ($this->settings->moderate != "enabled") {
            $this->sendTradeMessage(
                $this->offer->getSender(),
                $this->offer->getRecipient(),
        ...
        if ($publicID) {
            ...
            foreach ($privateIDs as $privateID) {
                ...
                if ($status == "pending") {
                    ...
                    $this->sendTradeMessage(
                        $privateOffer->getRecipient(),
                        $privateOffer->getSender(),
