...
class VmessageController extends AppController{
    ...
    public function view(){
	    $mysidia = Registry::get("mysidia");		
		if(!$mysidia->input->get("id") or !$mysidia->input->get("id2")) throw new InvalidIDException($mysidia->lang->user_nonexist);
		if($mysidia->input->get("id") == $mysidia->input->get("id2")) throw new DuplicateIDException($mysidia->lang->user_same);		
	...
	public function edit(){
	    ...
	    if($mysidia->input->post("submit")) $vmessage->edit();
	}
